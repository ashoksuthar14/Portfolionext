  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        MY <span className="text-purple">Unique Selling Point</span>
      </h1>

      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
          title="Rapid Adaptation"
          icon={<MagicButton title="USP 1" asChild />}
          description="Mastered CrewAI and Agentic AI frameworks during a 48-hour hackathon and successfully implemented them to win the competition."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          title="Scale Builder"
          icon={<MagicButton title="USP 2" asChild />}
          description="Delivered 50+ AI/ML mini-projects for a university client, demonstrating expertise across diverse domains from computer vision to NLP."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title="Tech Mentor"
          icon={<MagicButton title="USP 3" asChild />}
          description="Led two non-AI teammates to hackathon victory by teaching them AI fundamentals and guiding them through project development in real-time."
        >
          <CanvasRevealEffect
            animationSpeed={3}
